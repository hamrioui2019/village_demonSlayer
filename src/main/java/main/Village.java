...
//   Ajouter une liste de demonSlayerSedentaire pour nous permettre de récupérer leurs informations et les lier au village 
	...
	private Affichage afficherVillage;

	/**
	 * Constructeur d'objets de classe Village
	 */
	public Village(Affichage afficherVillage) {
		...
		this.afficherVillage = afficherVillage;
	...
	public void ajouterDemonSlayerSedentaire(DemonSlayerSedentaire demonslayer) {
		if ((demonslayer.getVillage() == null || demonslayer.getVillage() == this)
				&& !(this.listDemonSlayerSedentaires.contains(demonslayer))) {
	...
	public String afficher() {
		return afficherVillage.afficher(this);
	}
}
